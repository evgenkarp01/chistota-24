<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<div class="contacts-wrapper clearfix">
      <div class="col-sm-6">
          <div class="adrs">
             <div class="ttl">
                 <h4>Для связи:</h4>
              ...
              <div class="address">
                    <p>г. Мтищи ул. Садовая д.64</p>
                    <p>Каждый день без выходных</p>
                    <p><i><img src="assets/site/img/clock.png" alt=""></i>С 9:00 по 20:00</p>
              </div>
              <div class="email">
                  <p><i><img src="assets/site/img/envelope.png" alt=""></i><a href="mailto:[[++email]]">[[++email]]</a></p>
              </div>
              <div class="phone">
                  <p><i><img src="assets/site/img/phone.png" alt=""></i><a href="tel:[[++phoneOne]]">[[++phoneOne]]</a></p>
                  <p><i><img src="assets/site/img/phone.png" alt=""></i><a href="tel:[[++phoneTwo]]">[[++phoneTwo]]</a></p>
              </div>
              <div class="social">
          ...
          <div class="backform">
              ...
              <form action="">
                 <fieldset>
                  ...
                  <input placeholder="Ваш телефон или e-mail" type="text">
                  <textarea placeholder="Ваше сообщение" name="" id="" cols="30" rows="10"></textarea>
                  <div class="btn callback-btn"><button>Отправить</button></div>
                </fieldset>
              </form>
          </div>
      </div>
	...
	<div class="container">
		<div class="row">
			<div class="flex-wrap oplet">
				...
				<div class="menu">
					<nav class="mmenu">
    <ul class=""><li class="first"><a href="/" >Главная</a></li><li><a href="vse-uslugi/" >Услуги</a></li><li><a href="o-nas/" >О нас</a></li><li><a href="kalkulyator.html" >Калькулятор</a></li><li class="last active"><a href="kontaktyi.html" >Контакты</a></li></ul>
</nav>
					<div id="sandwich">
    	...
    	<section class="content">
    	    <div class="container">
    	        <div class="row">
                    <div class="contacts-page contain clearfix vilet">
      ...
      <div class="col-sm-6">
          <div class="adrs">
             <div class="ttl">
              ...
              <div class="email">
                  <p><i><img src="assets/site/img/envelope.png" alt=""></i><a href="mailto:info@chistota-24.ru">info@chistota-24.ru</a></p>
              </div>
              <div class="phone">
                  <p><i><img src="assets/site/img/phone.png" alt=""></i><a href="tel:8(908)189-99-44">8(908)189-99-44</a></p>
                  <p><i><img src="assets/site/img/phone.png" alt=""></i><a href="tel:8(800)200-34-21">8(800)200-34-21</a></p>
              </div>
              <div class="social">
...
<script src="assets/site/js/custom.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBGz-j7e8PmaFlyPGd-F2EU8wETucbHH8I"></script>
<script>
    var locations = [
