<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1532029235,
    'editedby' => 1,
    'editedon' => 1532197884,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1532029200,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<body>
    ...
    <ul class=""><li class="first"><a href="/" >Главная</a></li><li class="active"><a href="vse-uslugi/" >Услуги</a></li><li><a href="o-nas/" >О нас</a></li><li><a href="kalkulyator.html" >Калькулятор</a></li><li class="last"><a href="kontaktyi.html" >Контакты</a></li></ul>
    	...
    	<section class="content">
    	    <div class="container">
    	        <div class="row">
                    <div class="services contain clearfix vilet">
...
<script src="assets/site/js/jquery.magnific-popup.min.js"></script>
<script src="assets/site/js/custom.js"></script>',
    '[[$mapGoogle]]' => '<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBGz-j7e8PmaFlyPGd-F2EU8wETucbHH8I"></script>
<script>
    var locations = [
...
`&toPlaceholder=``&parents=`5`&includeContent=``&includeTVs=`servicesOutTv`&prepareTVs=`1`&processTVs=``&tvPrefix=`tv.`&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=``&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`page.total`&resources=``&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``&plPrefix=``&maxLimit=`100`&page=`1`&pageVarKey=`page`&pageLimit=`5`&element=`pdoResources`&pageNavVar=`page.nav`&pageCountVar=`pageCount`&pageLinkScheme=``&tplPage=`@INLINE <li><a href="[[+href]]">[[+pageNo]]</a></li>`&tplPageWrapper=`@INLINE <div class="pagination"><ul class="pagination">[[+first]][[+prev]][[+pages]][[+next]][[+last]]</ul></div>`&tplPageActive=`@INLINE <li class="active"><a href="[[+href]]">[[+pageNo]]</a></li>`&tplPageFirst=`@INLINE <li class="control"><a href="[[+href]]">[[%pdopage_first]]</a></li>`&tplPageLast=`@INLINE <li class="control"><a href="[[+href]]">[[%pdopage_last]]</a></li>`&tplPagePrev=`@INLINE <li class="control"><a href="[[+href]]">&laquo;</a></li>`&tplPageNext=`@INLINE <li class="control"><a href="[[+href]]">&raquo;</a></li>`&tplPageSkip=`@INLINE <li class="disabled"><span>...</span></li>`&tplPageFirstEmpty=`@INLINE <li class="disabled"><span>[[%pdopage_first]]</span></li>`&tplPageLastEmpty=`@INLINE <li class="disabled"><span>[[%pdopage_last]]</span></li>`&tplPagePrevEmpty=`@INLINE <li class="disabled"><span>&laquo;</span></li>`&tplPageNextEmpty=`@INLINE <li class="disabled"><span>&raquo;</span></li>`&cache=``&cacheTime=`3600`&cacheAnonymous=``&ajax=``&ajaxMode=``&ajaxElemWrapper=`#pdopage`&ajaxElemRows=`#pdopage .rows`&ajaxElemPagination=`#pdopage .pagination`&ajaxElemLink=`#pdopage .pagination a`&ajaxElemMore=`#pdopage .btn-more`&ajaxTplMore=`@INLINE <button class="btn btn-default btn-more">[[%pdopage_more]]</button>`&ajaxHistory=``&setMeta=`1`&strictMode=`1`&request=`2afd689c2c0f5db35223b4c38c37f1ca`&setTotal=`1`]]' => '<div class="col-sm-4 col-md-3">
   <div class="services-card">
       ...
       <a href="http://chistota-24.ru/vse-uslugi/standartnaya-uborka-kvartiryi.html"></a>
   </div>
</div>
<div class="col-sm-4 col-md-3">
   <div class="services-card">
       <div class="img"><img src="/assets/cache_image/noimage_270x165_f05.jpg" alt="Стандартная уборка коттеджей и домов"></div>
       <div class="ttl">Стандартная уборка коттеджей и домов</div>
       <a href="http://chistota-24.ru/vse-uslugi/standartnaya-uborka-kottedzhej-i-domov.html"></a>
   </div>
</div>
<div class="col-sm-4 col-md-3">
   <div class="services-card">
       <div class="img"><img src="/assets/cache_image/noimage_270x165_f05.jpg" alt="Ежедневная уборка офиса по графику"></div>
       <div class="ttl">Ежедневная уборка офиса по графику</div>
       <a href="http://chistota-24.ru/vse-uslugi/ezhednevnaya-uborka-ofisa-po-grafiku.html"></a>
   </div>
</div>
<div class="col-sm-4 col-md-3">
   <div class="services-card">
       <div class="img"><img src="/assets/cache_image/assets/site/img/services/_270x165_f05.jpg" alt="Генеральная уборка квартиры"></div>
       <div class="ttl">Генеральная уборка квартиры</div>
       <a href="http://chistota-24.ru/vse-uslugi/generalnaya-uborka-kvartiryi.html"></a>
   </div>
</div>
<div class="col-sm-4 col-md-3">
   <div class="services-card">
       <div class="img"><img src="/assets/cache_image/assets/site/img/services/ уборка коттеджей и домов_270x165_f05.jpg" alt="Генеральная уборка коттеджей и домов"></div>
       <div class="ttl">Генеральная уборка коттеджей и домов</div>
       <a href="http://chistota-24.ru/vse-uslugi/generalnaya-uborka-kottedzhej-i-domov.html"></a>
   </div>
</div>
<div class="col-sm-4 col-md-3">
   <div class="services-card">
       <div class="img"><img src="/assets/cache_image/assets/site/img/services/ уборка офиса по графику_270x165_f05.jpg" alt="Генеральная уборка офиса"></div>
       <div class="ttl">Генеральная уборка офиса</div>
       <a href="http://chistota-24.ru/vse-uslugi/generalnaya-uborka-ofisa.html"></a>
   </div>
</div>
<div class="col-sm-4 col-md-3">
   <div class="services-card">
       <div class="img"><img src="/assets/cache_image/noimage_270x165_f05.jpg" alt="Уборка квартиры после ремонта"></div>
       <div class="ttl">Уборка квартиры после ремонта</div>
       <a href="http://chistota-24.ru/vse-uslugi/uborka-kvartiryi-posle-remonta.html"></a>
   </div>
</div>
<div class="col-sm-4 col-md-3">
   <div class="services-card">
       <div class="img"><img src="/assets/cache_image/noimage_270x165_f05.jpg" alt="Уборка коттеджей и домов после ремонта"></div>
       <div class="ttl">Уборка коттеджей и домов после ремонта</div>
       <a href="http://chistota-24.ru/vse-uslugi/uborka-kottedzhej-i-domov-posle-remonta.html"></a>
   </div>
</div>
<div class="col-sm-4 col-md-3">
   <div class="services-card">
       <div class="img"><img src="/assets/cache_image/assets/site/img/services/services1_270x165_f05.jpg" alt="Уборка офиса после ремонта"></div>
       <div class="ttl">Уборка офиса после ремонта</div>
       <a href="http://chistota-24.ru/vse-uslugi/uborka-ofisa-posle-remonta.html"></a>
   </div>
</div>
<div class="col-sm-4 col-md-3">
   <div class="services-card">
       <div class="img"><img src="/assets/cache_image/noimage_270x165_f05.jpg" alt="Уборка квартиры после пожара"></div>
       <div class="ttl">Уборка квартиры после пожара</div>
       <a href="http://chistota-24.ru/vse-uslugi/uborka-kvartiryi-posle-pozhara.html"></a>
   </div>
</div>
<div class="col-sm-4 col-md-3">
   <div class="services-card">
       <div class="img"><img src="/assets/cache_image/noimage_270x165_f05.jpg" alt="Уборка придомовой территории коттеджей/домов"></div>
       <div class="ttl">Уборка придомовой территории коттеджей/домов</div>
       <a href="http://chistota-24.ru/vse-uslugi/uborka-pridomovoj-territorii-kottedzhej/domov.html"></a>
   </div>
</div>
<div class="col-sm-4 col-md-3">
   <div class="services-card">
       <div class="img"><img src="/assets/cache_image/noimage_270x165_f05.jpg" alt="Химчистка мягкой мебели"></div>
       <div class="ttl">Химчистка мягкой мебели</div>
       <a href="http://chistota-24.ru/vse-uslugi/ximchistka-myagkoj-mebeli.html"></a>
   </div>
</div>',
  ),
  'sourceCache' => 
...
<script src="assets/site/js/custom.js"></script>',
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBGz-j7e8PmaFlyPGd-F2EU8wETucbHH8I"></script>
<script>
    var locations = [
            ["Ульяновская д.25", 47.216003, 39.714761, "http://ewal-web.ru/assets/site/img/mapmark.png"],
        ];
    ...
    ',
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBGz-j7e8PmaFlyPGd-F2EU8wETucbHH8I"></script>
<script>
    var locations = [
            ["Ульяновская д.25", 47.216003, 39.714761, "http://ewal-web.ru/assets/site/img/mapmark.png"],
        ];
