<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Главная',
    'longtitle' => 'Профессиональный клининг',
    'description' => '',
    'alias' => 'index',
    'link_attributes' => '',
    'published' => 1,
...
<p>Наши работники проходят строгий отбор и допускаются к работе только после проверки профессиональных навыков. Ценовая политика SolidCare базируется на понимании потребностей человека, ведь мы работаем специально для клиента и хотим его порадовать качеством уборки.</p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 0,
    'searchable' => 1,
    ...
    array (
      0 => 'specialIndexTv',
      1 => 'Если Ваше помещение не подходит под описание или другие класификации – сообщите нам, пожалуйста, все подробности и мы обязательно договоримся!',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'titleStock',
      1 => '<span>Акция!</span> Приведи друга',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'descStepTwoTv',
      1 => 'Друзья оформляют первую уборку со скидкой 500 руб',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'descStepThreeTv',
      1 => 'Ваша следующая уборка на 500 руб дешевле!',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'descStepFourTv',
      1 => 'Скидка 500РУБ! Назовите Имя, номер телефона и адрес предыдущей уборки друга для получения скидки',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'bannerTwoTv',
      1 => 'НАЧНЕМ НОВУЮ<br>ИСТОРИЮ ЧИСТОТЫ?',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'bannerOneTv',
      1 => 'Наш сервис —<br>это высшее качество!',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    'listArrowBannerThreeTv' => 
    array (
      0 => 'listArrowBannerThreeTv',
    ...
    'listMarkBannerThreeTv' => 
    array (
      0 => 'listMarkBannerThreeTv',
	...
	<div class="btn btn-services-index"><a href="vse-uslugi/"><button>Перейти в услуги</button></a></div>
		...
		<section class="price-index">
							...
							<div class="col-md-6">
								<div class="row">
									...
									<div class="note">
										<div class="txt">
											<p>
												<sup>*</sup> Если Ваше помещение не подходит под описание или другие класификации – сообщите нам, пожалуйста, все подробности и мы обязательно договоримся!
											</p>
										</div>
									</div>
								</div>
			...
			<div class="btn btn-price">
				<a href="kalkulyator.html"><button>Заказать уборку</button></a>
			</div>
		</section>
		<section class="stock-index">
		    <div class="container">
		        <div class="row">
		            <div class="ttl-head ttl-stock-index">
		                <h2><span>Акция!</span> Приведи друга</h2>
		            </div>
		            <div class="stk">
		                <div class="item one-itm"><img src="assets/site/img/link-ico.png" alt="">
		                    <div class="desc"><p>Расскажите о нас друзьям</p></div>
		                </div>
		                <div class="item arrow-one arrow"><img src="assets/site/img/arrow-ico.png" alt=""></div>
		                <div class="item two-itm"><img src="assets/site/img/giv-ico.png" alt="">
		                    <div class="desc"><p>Друзья оформляют первую уборку со скидкой 500 руб</p></div>
		                </div>
		                <div class="item arrow-two arrow"><img src="assets/site/img/arrow-ico.png" alt=""></div>
		                <div class="item three-itm"><img src="assets/site/img/cleaner-ico.png" alt="">
		                    <div class="desc"><p>Ваша следующая уборка на 500 руб дешевле!</p></div>
		                </div>
		                <div class="item four-itm"><img src="assets/site/img/money-ico.png" alt="">
		                    <div class="desc"><p>Скидка 500РУБ! Назовите Имя, номер телефона и адрес предыдущей уборки друга для получения скидки</p></div>
		                </div>
		            </div>
		        </div>
		    </div>
		</section>
		<section class="banner-index one-ban">
	<div class="ttl-banner">Наш сервис —<br>это высшее качество!</div>
</section>
		...
		<div class="row">
			...
			<div class="work">
				...
				<div class="work-img work-sldr-index zoom-gallery">
					<div class="item">
	<a href="assets/site/img/portfolio/gallery5.png"><img src="assets/site/img/portfolio/gallery5.png" title="Тестовое описание" alt="Тестовое описание"></a>
</div><div class="item">
	<a href="assets/site/img/portfolio/Mask Group.png"><img src="assets/site/img/portfolio/Mask Group.png" title="уу" alt="уу"></a>
</div><div class="item">
	<a href="assets/site/img/portfolio/Мытьё стен.jpg"><img src="assets/site/img/portfolio/Мытьё стен.jpg" title="[[+title]]" alt="[[+title]]"></a>
</div><div class="item">
	<a href="assets/site/img/portfolio/Стандартная уборка квартиры.jpg"><img src="assets/site/img/portfolio/Стандартная уборка квартиры.jpg" title="[[+title]]" alt="[[+title]]"></a>
</div>
				</div>
        ...
        <section class="banner-index two-ban">
	<div class="ttl-banner">НАЧНЕМ НОВУЮ<br>ИСТОРИЮ ЧИСТОТЫ?</div>
	<div class="btn btn-two-ban"><a href="kalkulyator.html"><button>Оформить заказ на уборку</button></a></div>
</section>
		<section class="banner-dop">
	<div class="container">
		<div class="row">
			<div class="ban-dop">
				<div class="col-md-6">
					<div class="left-list">
						<ul>
						    <li>Возникли сложности с оформлением заказа?</li><li>Или у Вас остались вопросы?</li><li>Желаете оформить заказ по телефону с помощью нашего менеджера?</li>
						</ul>
					</div>
				</div>
				<div class="col-md-6">
					<div class="right-list">
						<ul>
						    <li>Пишите нам на почту</li><li>Оставляйте свой номер – мы перезвоним</li><li>Звоните нам в офис</li><li>Пишите и подписывайтесь в соц.сетях (узнаете первыми о новых скидках, акциях и предложениях)</li>
						</ul>
					</div>
				</div>
		...
		<section class="seo-content-index">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
...
<script src="assets/site/js/custom.js"></script>
  ...
  array (
    ...
    '[[$advantageIndex]]' => '<section class="content">
    <div class="container">
        <div class="row">
            <div class="ttl-head ttl-advantage">
                <h2>Наши преимущества</h2>
    ...
    '[[$serviceIndex]]' => '<section class="services-index">
	<div class="container">
		<div class="row">
			<div class="ttl-head ttl-services-index">
				<h2>Наши услуги</h2>
    ...
    '[[$stockIndex]]' => '<section class="stock-index">
		    <div class="container">
		        <div class="row">
		            <div class="ttl-head ttl-stock-index">
		                <h2><span>Акция!</span> Приведи друга</h2>
    ...
    '[[$bannerIndexOne]]' => '<section class="banner-index one-ban">
	<div class="ttl-banner">Наш сервис —<br>это высшее качество!</div>
</section>',
    '[[$reviewIndex]]' => '<section class="review-index">
			<div class="container">
				<div class="row">
					<div class="ttl-head ttl-review-index">
						<h2>Отзывы наших клиентов</h2>
    ...
    '[[$worksIndex]]' => '<section class="works-index">
	<div class="container">
		<div class="row">
			<div class="ttl-head ttl-works">
				<h2>Наши работы</h2>
    ...
    '[[$bannerIndexTwo]]' => '<section class="banner-index two-ban">
	<div class="ttl-banner">НАЧНЕМ НОВУЮ<br>ИСТОРИЮ ЧИСТОТЫ?</div>
	<div class="btn btn-two-ban"><a href="kalkulyator.html"><button>Оформить заказ на уборку</button></a></div>
</section>',
    '[[getImageList? &tvname=`listArrowBannerThreeTv` &tpl=`listArrowBannerThreeTpl`]]' => '<li>Возникли сложности с оформлением заказа?</li><li>Или у Вас остались вопросы?</li><li>Желаете оформить заказ по телефону с помощью нашего менеджера?</li>',
    '[[getImageList? &tvname=`listMarkBannerThreeTv` &tpl=`listMarkBannerThreeTpl`]]' => '<li>Пишите нам на почту</li><li>Оставляйте свой номер – мы перезвоним</li><li>Звоните нам в офис</li><li>Пишите и подписывайтесь в соц.сетях (узнаете первыми о новых скидках, акциях и предложениях)</li>',
    '[[$bannerIndexThree]]' => '<section class="banner-dop">
	<div class="container">
		<div class="row">
			<div class="ban-dop">
				<div class="col-md-6">
    ...
    '[[$articleIndex]]' => '<section class="seo-content-index">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="ttl-head ttl-seo-content-index">
...
`&toPlaceholder=``&parents=`26`&includeContent=``&includeTVs=`imgSldrTv`&prepareTVs=`1`&processTVs=``&tvPrefix=`tv.`&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=``&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`page.total`&resources=``&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``&plPrefix=``&maxLimit=`100`&page=`1`&pageVarKey=`page`&pageLimit=`5`&element=`pdoResources`&pageNavVar=`page.nav`&pageCountVar=`pageCount`&pageLinkScheme=``&tplPage=`@INLINE <li><a href="[[+href]]">[[+pageNo]]</a></li>`&tplPageWrapper=`@INLINE <div class="pagination"><ul class="pagination">[[+first]][[+prev]][[+pages]][[+next]][[+last]]</ul></div>`&tplPageActive=`@INLINE <li class="active"><a href="[[+href]]">[[+pageNo]]</a></li>`&tplPageFirst=`@INLINE <li class="control"><a href="[[+href]]">[[%pdopage_first]]</a></li>`&tplPageLast=`@INLINE <li class="control"><a href="[[+href]]">[[%pdopage_last]]</a></li>`&tplPagePrev=`@INLINE <li class="control"><a href="[[+href]]">&laquo;</a></li>`&tplPageNext=`@INLINE <li class="control"><a href="[[+href]]">&raquo;</a></li>`&tplPageSkip=`@INLINE <li class="disabled"><span>...</span></li>`&tplPageFirstEmpty=`@INLINE <li class="disabled"><span>[[%pdopage_first]]</span></li>`&tplPageLastEmpty=`@INLINE <li class="disabled"><span>[[%pdopage_last]]</span></li>`&tplPagePrevEmpty=`@INLINE <li class="disabled"><span>&laquo;</span></li>`&tplPageNextEmpty=`@INLINE <li class="disabled"><span>&raquo;</span></li>`&cache=``&cacheTime=`3600`&cacheAnonymous=``&ajax=``&ajaxMode=``&ajaxElemWrapper=`#pdopage`&ajaxElemRows=`#pdopage .rows`&ajaxElemPagination=`#pdopage .pagination`&ajaxElemLink=`#pdopage .pagination a`&ajaxElemMore=`#pdopage .btn-more`&ajaxTplMore=`@INLINE <button class="btn btn-default btn-more">[[%pdopage_more]]</button>`&ajaxHistory=``&setMeta=`1`&strictMode=`1`&request=`e5f13414a3a5f9e24248148d067a5153`&setTotal=`1`]]' => '<div class="item">
    ...
    <div class="opl">
    	...
    	<div class="btn btn-slider"><a href="kalkulyator.html"><button>Заказать уборку!</button></a></div>
    </div>
</div>
<div class="item">
    <div class="pic"><img src="/assets/cache_image/assets/site/img/slider/slide1_1920x850_8bd.jpg" alt="Уборка офиса — безопасность сотрудников<br>и престиж компании!"></div>
    <div class="opl">
    	<div class="desc">Уборка офиса — безопасность сотрудников<br>и престиж компании!</div>
    	<div class="btn btn-slider"><a href="kalkulyator.html"><button>Заказать уборку!</button></a></div>
    </div>
</div>
<div class="item">
    <div class="pic"><img src="/assets/cache_image/assets/site/img/slider/slide2_1920x850_8bd.jpg" alt="Уборка офиса — безопасность сотрудников и престиж компании!"></div>
    <div class="opl">
    	<div class="desc">Уборка офиса — безопасность сотрудников и престиж компании!</div>
    	<div class="btn btn-slider"><a href="kalkulyator.html"><button>Заказать уборку!</button></a></div>
    </div>
</div>',
...
`&toPlaceholder=``&parents=`27`&includeContent=`1`&includeTVs=`imgAdvantageTv`&prepareTVs=`1`&processTVs=``&tvPrefix=`tv.`&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=``&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`page.total`&resources=``&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``&plPrefix=``&maxLimit=`100`&page=`1`&pageVarKey=`page`&pageLimit=`5`&element=`pdoResources`&pageNavVar=`page.nav`&pageCountVar=`pageCount`&pageLinkScheme=``&tplPage=`@INLINE <li><a href="[[+href]]">[[+pageNo]]</a></li>`&tplPageWrapper=`@INLINE <div class="pagination"><ul class="pagination">[[+first]][[+prev]][[+pages]][[+next]][[+last]]</ul></div>`&tplPageActive=`@INLINE <li class="active"><a href="[[+href]]">[[+pageNo]]</a></li>`&tplPageFirst=`@INLINE <li class="control"><a href="[[+href]]">[[%pdopage_first]]</a></li>`&tplPageLast=`@INLINE <li class="control"><a href="[[+href]]">[[%pdopage_last]]</a></li>`&tplPagePrev=`@INLINE <li class="control"><a href="[[+href]]">&laquo;</a></li>`&tplPageNext=`@INLINE <li class="control"><a href="[[+href]]">&raquo;</a></li>`&tplPageSkip=`@INLINE <li class="disabled"><span>...</span></li>`&tplPageFirstEmpty=`@INLINE <li class="disabled"><span>[[%pdopage_first]]</span></li>`&tplPageLastEmpty=`@INLINE <li class="disabled"><span>[[%pdopage_last]]</span></li>`&tplPagePrevEmpty=`@INLINE <li class="disabled"><span>&laquo;</span></li>`&tplPageNextEmpty=`@INLINE <li class="disabled"><span>&raquo;</span></li>`&cache=``&cacheTime=`3600`&cacheAnonymous=``&ajax=``&ajaxMode=``&ajaxElemWrapper=`#pdopage`&ajaxElemRows=`#pdopage .rows`&ajaxElemPagination=`#pdopage .pagination`&ajaxElemLink=`#pdopage .pagination a`&ajaxElemMore=`#pdopage .btn-more`&ajaxTplMore=`@INLINE <button class="btn btn-default btn-more">[[%pdopage_more]]</button>`&ajaxHistory=``&setMeta=`1`&strictMode=`1`&request=`431347f6122e1655907d433085ac7783`&setTotal=`1`]]' => '<div class="col-md-4 col-sm-6">
   <div class="item">
        ...
        <div class="wrap">
           <span class="ttl">Гарантия качества!</span>
            <span class="txt"><p>Высокий уровень профессионализма и большой опыт нашего персонала позволяют выполнять уборку не просто хорошо, а превосходно, не тратя на это много времени. Если Вам что-то не понравилось, оперативно исправим.</p></span>
       </div>
    </div>
</div>
<div class="col-md-4 col-sm-6">
   <div class="item">
        <div class="ico">
            <img src="/assets/cache_image/assets/site/img/icons/ico-adv-2_90x90_fbd.png" alt="">
        </div>
        <div class="wrap">
           <span class="ttl">Держим низкие цены,</span>
            <span class="txt"><p>придерживаясь высокого качества оказываемых услуг.</p></span>
       </div>
    </div>
</div>
<div class="col-md-4 col-sm-6">
   <div class="item">
        <div class="ico">
            <img src="/assets/cache_image/assets/site/img/icons/ico-adv-3_90x90_fbd.png" alt="">
        </div>
        <div class="wrap">
           <span class="ttl">Без предоплаты!</span>
            <span class="txt"><p>Оплата только после выполнения работы.</p></span>
       </div>
    </div>
</div>
<div class="col-md-4 col-sm-6">
   <div class="item">
        <div class="ico">
            <img src="/assets/cache_image/assets/site/img/icons/ico-adv-4_90x90_fbd.png" alt="">
        </div>
        <div class="wrap">
           <span class="ttl">Благодаря удобной форме онлайн - заявки,</span>
            <span class="txt"><p>вы можете сделать заказ, не выходя из дома, или не покидая своего рабочего места.</p></span>
       </div>
    </div>
</div>
<div class="col-md-4 col-sm-6">
   <div class="item">
        <div class="ico">
            <img src="/assets/cache_image/assets/site/img/icons/ico-adv-5_90x90_fbd.png" alt="">
        </div>
        <div class="wrap">
           <span class="ttl">В нашем арсенале самое современное</span>
            <span class="txt"><p>клининговое оборудование для любой поверхности!</p></span>
       </div>
    </div>
</div>
<div class="col-md-4 col-sm-6">
   <div class="item">
        <div class="ico">
            <img src="/assets/cache_image/assets/site/img/icons/ico-adv-6_90x90_fbd.png" alt="">
        </div>
        <div class="wrap">
           <span class="ttl">Мы используем только качественные</span>
            <span class="txt"><p>моющие средства для любых поверхностей. Только специально подобранные средства смогут дать самый лучший результат!</p></span>
       </div>
    </div>
</div>
<div class="col-md-4 col-sm-6">
   <div class="item">
        <div class="ico">
            <img src="/assets/cache_image/assets/site/img/icons/ico-adv-7_90x90_fbd.png" alt="">
        </div>
        <div class="wrap">
           <span class="ttl">Оперативность</span>
            <span class="txt"><p>Максимально быстрое предоставление услуг в указанном месте.</p></span>
       </div>
    </div>
</div>
<div class="col-md-4 col-sm-6">
   <div class="item">
        <div class="ico">
            <img src="/assets/cache_image/assets/site/img/icons/ico-adv-8_90x90_fbd.png" alt="">
        </div>
        <div class="wrap">
           <span class="ttl">Бесплатная доставка.</span>
            <span class="txt"><p>Мы не берем деньги за доставку нашего оборудования и моющих средств!</p></span>
       </div>
    </div>
</div>
<div class="col-md-4 col-sm-6">
   <div class="item">
        <div class="ico">
            <img src="/assets/cache_image/assets/site/img/icons/ico-adv-9_90x90_fbd.png" alt="">
        </div>
        <div class="wrap">
           <span class="ttl">Мы работаем для вас,</span>
            <span class="txt"><p>Вкак часы — без перерывов и выходных.</p></span>
       </div>
    </div>
</div>',
...
<div class="col-sm-4 col-xs-12">
	<div class="item">
		<div class="auhtor"><img src="/assets/cache_image/assets/site/img/lera_90x90_fbd.png" alt=""></div>
		<div class="name">Ирина Нестеренко</div>
		<div class="seporate"></div>
		<div class="desc">
			<p>
				<p><span>В рамках спецификации современных стандартов, ключевые особенности структуры проекта неоднозначны и</span></p>
			</p>
		</div>
	</div>
</div>
<div class="col-sm-4 col-xs-12">
	<div class="item">
		<div class="auhtor"><img src="/assets/cache_image/assets/site/img/lera_90x90_fbd.png" alt="Валерия Кортошова"></div>
		<div class="name">Валерия Кортошова</div>
		<div class="seporate"></div>
		<div class="desc">
			<p>
				<p><span>В рамках спецификации современных стандартов, ключевые особенности структуры проекта неоднозначны и будут объединены в целые кластеры себе подобных.</span></p>
			</p>
		</div>
	</div>
</div>',
  ...
  array (
    ...
    <div class="container">
      ...
      array (
        ...
        array (
          ...
          'category' => 4,
          'cache_type' => 0,
          'snippet' => '<section class="services-index">
	<div class="container">
		<div class="row">
			<div class="ttl-head ttl-services-index">
				<h2>[[*titleService]]</h2>
	...
	<div class="btn btn-services-index"><a href="[[~5]]"><button>Перейти в услуги</button></a></div>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="services-index">
	<div class="container">
		<div class="row">
			<div class="ttl-head ttl-services-index">
				<h2>[[*titleService]]</h2>
	...
	<div class="btn btn-services-index"><a href="[[~5]]"><button>Перейти в услуги</button></a></div>
      ...
      array (
        ...
        array (
          ...
          'category' => 4,
          'cache_type' => 0,
          'snippet' => '<section class="price-index">
			<div class="container">
				<div class="row">
					<div class="ttl-head price-index-ttl">
						<h2>[[*titlePrice]]</h2>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="price-index">
			<div class="container">
				<div class="row">
					<div class="ttl-head price-index-ttl">
						<h2>[[*titlePrice]]</h2>
      ...
      array (
        ...
        array (
          ...
          'category' => 4,
          'cache_type' => 0,
          'snippet' => '<section class="stock-index">
		    <div class="container">
		        <div class="row">
		            <div class="ttl-head ttl-stock-index">
		                <h2>[[*titleStock]]</h2>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="stock-index">
		    <div class="container">
		        <div class="row">
		            <div class="ttl-head ttl-stock-index">
		                <h2>[[*titleStock]]</h2>
      ...
      array (
        ...
        array (
          ...
          'category' => 4,
          'cache_type' => 0,
          'snippet' => '<section class="banner-index one-ban">
	<div class="ttl-banner">[[*bannerOneTv]]</div>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="banner-index one-ban">
	<div class="ttl-banner">[[*bannerOneTv]]</div>
</section>',
        ),
        'policies' => 
      ...
      array (
        ...
        array (
          ...
          'category' => 4,
          'cache_type' => 0,
          'snippet' => '<section class="review-index">
			<div class="container">
				<div class="row">
					<div class="ttl-head ttl-review-index">
						<h2>[[*titleReview]]</h2>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="review-index">
			<div class="container">
				<div class="row">
					<div class="ttl-head ttl-review-index">
						<h2>[[*titleReview]]</h2>
      ...
      array (
        ...
        array (
          ...
          'category' => 4,
          'cache_type' => 0,
          'snippet' => '<section class="works-index">
	<div class="container">
		<div class="row">
			<div class="ttl-head ttl-works">
				<h2>[[*titleWorks]]</h2>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="works-index">
	<div class="container">
		<div class="row">
			<div class="ttl-head ttl-works">
				<h2>[[*titleWorks]]</h2>
      ...
      array (
        ...
        array (
          ...
          'category' => 4,
          'cache_type' => 0,
          'snippet' => '<section class="banner-index two-ban">
	...
	<div class="btn btn-two-ban"><a href="[[~7]]"><button>Оформить заказ на уборку</button></a></div>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="banner-index two-ban">
	<div class="ttl-banner">[[*bannerTwoTv]]</div>
	<div class="btn btn-two-ban"><a href="[[~7]]"><button>Оформить заказ на уборку</button></a></div>
</section>',
        ),
      ...
      array (
        ...
        array (
          ...
          'source' => 2,
          'property_preprocess' => false,
          'name' => 'bannerIndexThree',
          'description' => '',
          'editor_type' => 0,
          'category' => 4,
          'cache_type' => 0,
          'snippet' => '<section class="banner-dop">
	<div class="container">
		<div class="row">
			<div class="ban-dop">
				<div class="col-md-6">
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="banner-dop">
	<div class="container">
		<div class="row">
			<div class="ban-dop">
				<div class="col-md-6">
      ...
      array (
        ...
        array (
          ...
          'category' => 4,
          'cache_type' => 0,
          'snippet' => '<section class="seo-content-index">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="ttl-head ttl-seo-content-index">
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="seo-content-index">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="ttl-head ttl-seo-content-index">
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'type' => 'text',
          'name' => 'titleAdvantage',
          'caption' => 'Заголовок раздела преимуществ',
          'description' => '',
          'editor_type' => 0,
          'category' => 10,
          'locked' => false,
      ...
      array (
        ...
        array (
          ...
          'type' => 'text',
          'name' => 'titleService',
          'caption' => 'Заголовок раздела услуг',
          'description' => '',
          'editor_type' => 0,
          'category' => 11,
          'locked' => false,
      ...
      array (
        ...
        array (
          ...
          'type' => 'text',
          'name' => 'titlePrice',
          'caption' => 'Заголовок раздела цены',
          'description' => '',
          'editor_type' => 0,
          'category' => 12,
          'locked' => false,
      ...
      array (
        ...
        array (
          ...
          'type' => 'text',
          'name' => 'titleStock',
          'caption' => 'Заголовок раздела акции',
          'description' => 'Между <span></span> выделяется красная область',
          'editor_type' => 0,
          'category' => 13,
          'locked' => false,
          'elements' => '',
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'type' => 'text',
          'name' => 'descStepThreeTv',
          'caption' => 'Описание третьего шага',
          'description' => '',
          'editor_type' => 0,
          'category' => 13,
          'locked' => false,
      ...
      array (
        ...
        array (
          ...
          'type' => 'image',
          'name' => 'imgStepFourTv',
          'caption' => 'Иконка четвертого шага',
          'description' => '',
          'editor_type' => 0,
          'category' => 13,
          'locked' => false,
      ...
      array (
        ...
        array (
          ...
          'type' => 'text',
          'name' => 'descStepFourTv',
          'caption' => 'Описание четвертого шага',
          'description' => '',
          'editor_type' => 0,
          'category' => 13,
          'locked' => false,
      ...
      array (
        ...
        array (
          ...
          'type' => 'text',
          'name' => 'bannerOneTv',
          'caption' => 'Лозунг для первого баннера',
          'description' => '',
          'editor_type' => 0,
          'category' => 16,
          'locked' => false,
      ...
      array (
        ...
        array (
          ...
          'type' => 'text',
          'name' => 'titleReview',
          'caption' => 'Заголовок раздела отзывов',
          'description' => '',
          'editor_type' => 0,
          'category' => 14,
          'locked' => false,
      ...
      array (
        ...
        array (
          ...
          'type' => 'text',
          'name' => 'titleWorks',
          'caption' => 'Заголовок раздела работ (портфолио)',
          'description' => '',
          'editor_type' => 0,
          'category' => 15,
          'locked' => false,
      ...
      array (
        ...
        array (
          ...
          'type' => 'text',
          'name' => 'bannerTwoTv',
          'caption' => 'Лозунг для второго баннера',
          'description' => '',
          'editor_type' => 0,
          'category' => 16,
          'locked' => false,
